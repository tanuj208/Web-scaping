...
f = csv.writer(open('in_book.csv', 'w'), delimiter=';', quoting=csv.QUOTE_ALL)
f.writerow(['Name', 'URL', 'Author', 'Price',
            'Number of Ratings', 'Average Rating'])

links = ["https://www.amazon.in/gp/bestsellers/books/"]
links.append(
    "https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_2?ie=UTF8&pg=2")
links.append(
    "https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_3?ie=UTF8&pg=3")
links.append(
    "https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_4?ie=UTF8&pg=4")
links.append(
    "https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_5?ie=UTF8&pg=5")
